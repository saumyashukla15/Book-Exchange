...
<% try {    
           String e= session.getAttribute("email").toString();
            ...
            PreparedStatement ps=cn.prepareStatement("select * from bookswap where email='"+e+"'");
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="text" name="address" class="form-control mb-3" id="address" placeholder="Address" value="<%=address%>"  >
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input type="text" name="street" class="form-control" id="street_address" placeholder="Street" value="<%=street%>" >
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input type="text" name="state" class="form-control" id="city" placeholder="State" value="<%=state%>">
                                    </div>
                                      <div class="col-12 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <input type="text"  name="zipcode" class="form-control" id="zipCode" placeholder="Zip Code" value="<%=zipcode%>"  >
                                    </div>
    ...
    <%
        ...
        try {
            ...
            PreparedStatement ps1=cn.prepareStatement("update bookswap set name=?,phone=?,address=?,street=?,state=?,country=?,zipcode=? where email='"+email2+"'");
            ps1.setString(1,name1);
            ps1.setString(2,phone4);
            ps1.setString(3,address);
            ps1.setString(4,street);
            ps1.setString(5,state);
            ps1.setString(6,country1);
...
out.println("<meta http-equiv='Refresh' content='0; url=UpdateUserInfo.jsp'/>");
        ...
        try
        {
         ...
         String sql="SELECT filename FROM bookswap where email='"+email+"'";
