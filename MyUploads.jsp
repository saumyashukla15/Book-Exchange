...
//             String id=request.getParameter("idupload");   
            PreparedStatement ps=cn.prepareStatement("select * from upload where email='"+e+"'");
            ResultSet rs=ps.executeQuery();
            while(rs.next()) {
                int id=rs.getInt("idupload");
                String filename=rs.getString("filename");
                String title=rs.getString("title");
                String description=rs.getString("description");
//                
            %>
                                <tbody style="font-family: serif;font-size-adjust: 15px">
                                    <tr>
                                        ...
                                        <td style="text-align: 15px"><a href="EditBook.jsp?idupload=<%=id%>" class="fa fa-edit">Edit</a></td>
                                    </tr>
